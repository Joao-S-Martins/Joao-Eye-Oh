  ...
  presets: [
    [
      ...
      ({
        ...
        sitemap: {
          changefreq: 'monthly', /* cspell: disable-line */
          priority: 0.5,
          ignorePatterns: ['/tags/**'],
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/Joao-S-Martins/docusaurus',
            label: 'GitHub',
            position: 'right',
          },
        ],
      ...
      footer: {
        ...
        //   },
        // ],
        copyright: `Copyright © ${new Date().getFullYear()} Jo&atilde;o Martins`,
      },
      prism: {
        theme: lightTheme,
        darkTheme: darkTheme,
