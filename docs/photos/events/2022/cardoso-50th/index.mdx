...
<MasonryGallery>
  <GalleryImage alt="Roses on the alter" src={IMGS[1]} variant={IMG_ENUMS.VARIANTS.INLINE} />
  <GalleryImage alt="Crucifix on the alter" src={IMGS[2]} variant={IMG_ENUMS.VARIANTS.INLINE} />
  <GalleryImage alt="Joe and Leonilda sitting" src={IMGS[5]} variant={IMG_ENUMS.VARIANTS.INLINE} />
  <GalleryImage alt="Joao and Michael playing violas da terra" src={IMGS[7]} variant={IMG_ENUMS.VARIANTS.INLINE} />
  <GalleryImage alt="Joe placing a ring on Leonilda's finger" src={IMGS[6]} variant={IMG_ENUMS.VARIANTS.INLINE} />
</MasonryGallery>
...
<ScrollGallery>
  <ScrollImage alt="Aliciana feeding Mia" src={IMGS[15]} variant={IMG_ENUMS.VARIANTS.FILL} />
  <ScrollCaption style={{position: 'relative'}}>She asked us for a baby sister after this.</ScrollCaption>
  <ScrollImage alt="The Cardosos opening the large dessert table" src={IMGS[14]} variant={IMG_ENUMS.VARIANTS.FILL} />
  <ScrollImage alt="The Cardosos cutting the cake" src={IMGS[16]} variant={IMG_ENUMS.VARIANTS.FILL} />
</ScrollGallery>
