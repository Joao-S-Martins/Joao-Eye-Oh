...
import ScrollGallery from '../../../../../src/components/galleries/ScrollGallery';
...
<ScrollGallery>
  <GalleryImage alt="Aliciana feeding Mia" src={IMGS[15]} variant={IMG_ENUMS.VARIANTS.FILL} />
  <GalleryImage alt="The Cardosos opening the large dessert table" src={IMGS[14]} variant={IMG_ENUMS.VARIANTS.FILL}>
    <GalleryCaption
  ...
  <div style={{position: 'relative'}}>All of Noelia's grandkids and their spouses</div>
  <GalleryImage alt="The Cardosos cutting the cake" src={IMGS[16]} variant={IMG_ENUMS.VARIANTS.FILL} />
</ScrollGallery>
